...
export const createUserStatusRequest = Router.post<ExtendedContextVariables>(
    "/user-status",
)
    ...
    .handler(async (context) => {
        ...
        return context.c.json({
            message: `${createUserStatusResult.value.rowCount} ${
                createUserStatusResult.value.rowCount === 1 ? "entry" : "entrys"
            } created`,
