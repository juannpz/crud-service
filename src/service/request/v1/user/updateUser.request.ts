...
export const updateUserRequest = Router.put<ExtendedContextVariables>(
    "/user/:user_id?",
)
    ...
    .handler(async (context) => {
        ...
        return context.c.json({
            message: `${updateUserResult.value.rowCount} ${
                updateUserResult.value.rowCount === 1 ? "entry" : "entrys"
            } updated`,
